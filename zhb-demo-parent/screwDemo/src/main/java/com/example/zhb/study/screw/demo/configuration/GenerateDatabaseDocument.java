package com.example.zhb.study.screw.demo.configuration;
...
/**
 * @ClassName: GenerateDatabaseDocument
 * @Description:
 * @Author: YuHao
 * @Date: 2022/3/25
 */
public class GenerateDatabaseDocument {
    public static void main(String[] args) {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://192.168.10.132:3306/gogs?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8");
