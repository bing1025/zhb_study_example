 ...
 */
@Service
public class Step2ActServiceImpl implements ActService{
    @Override
    public boolean containsEvent(String eventCode) {
        return ActEnum.STEP2.getActCode().equals(eventCode);
    }
    ...
    public boolean isAccept(ActEvent actEvent) {
        return ActEnum.STEP2.getActCode().equals(actEvent.getEventCode());
    }
}
