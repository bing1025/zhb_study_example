 ...
 */
@Service
public class Step1ActServiceImpl implements ActService{
    @Override
    public boolean containsEvent(String eventCode) {
        return ActEnum.STEP1.getActCode().equals(eventCode);
    }
    ...
    public boolean isAccept(ActEvent actEvent) {
        return ActEnum.STEP1.getActCode().equals(actEvent.getEventCode());
    }
}
